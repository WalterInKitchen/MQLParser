...
public class ToDecimal implements Function {
    public static final String FUNC_NAME = "toDecimal";
    ...
    public Expression call(List<Expression> args) {
        ...
        return ArithmeticExpression.build(args.get(0), ArithmeticExpression.Operator.TO_DECIMAL, null);
    }
}
