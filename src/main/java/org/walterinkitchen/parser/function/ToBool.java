...
public class ToBool implements Function {
    public static final String FUNC_NAME = "tobool";
    ...
    public Expression call(List<Expression> args) {
        ...
        return ArithmeticExpression.build(args.get(0), ArithmeticExpression.Operator.TO_BOOL, null);
    }
}
